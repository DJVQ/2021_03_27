...
import com.example.a2021_03_27.data.sqlite.RecordSQLiteOpenHelper;
import com.example.a2021_03_27.layout.edit_text.EditText_Clear;
...
public class SearchView extends LinearLayout {
    ...
    private com.example.a2021_03_27.view_page.searchview.bCallBack bCallBack; // 返回按键回调接口
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.black); // 默认颜色 = 黑色
        ...
        // 搜索框颜色
        int defaultColor2 = context.getResources().getColor(R.color.search_brown); // 默认颜色 = 棕色
